...
def args(version):
    ...
    parser.add_argument("-e", "--encode", metavar="FORMAT", choices=("md5", "base64", "hex", "url", "sha1", "sha256" , "sha512", "sha3-256", "sha3-512"), help="Encode/Hash the generated wordlist with a given algorithm")
    ...
    parser.add_argument("-N", "--noprogress", dest="noprog", action="store_true", default=False, help="Disables progress bar (increses performance)")
    parser.add_argument("-v", "--version", action="version", version=f"v{version}", help="Returns the version of the program.")
